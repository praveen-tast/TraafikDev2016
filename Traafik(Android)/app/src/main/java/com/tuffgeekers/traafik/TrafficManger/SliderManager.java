...
import com.tuffgeekers.traafik.GeneralUser.TrafficChat;
 ...
 */
public class SliderManager extends Activity {
    SimpleSideDrawer drawer_left, drawer_right;
    LinearLayout ll_navigate, ll_traafik, ll_inbox,ll_share_location, ll_send, ll_setting, ll_sounds, ll_advertise, ll_goslow, ll_police, ll_accident, ll_traafic_chat, ll_hazard, ll_place, ll_road_closed, ll_checkin, ll_traafik_feed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer_left.setLeftBehindContentView(R.layout.activity_slider_manager);
...
ll_share_location=(LinearLayout)findViewById(R.id.ll_share_location);
    ...
    private void ll_goslowClick() {
        ...
        Intent goslow = new Intent(SliderManager.this, GoslowDetails.class);
    ...
    private void ll_traafic_chatClick() {
        ...
        Intent goslow = new Intent(SliderManager.this,TrafficChat.class);
        startActivity(goslow);
    ...
    private void ll_traafik_feedClick() {
        ...
        Intent goslow = new Intent(SliderManager.this, TraafikFeed.class);
        startActivity(goslow);
    }
    ...
    private void ll_traafikClick() {
        ...
        ll_advertise.setBackgroundColor(Color.parseColor("#515151"));
        ll_share_location.setBackgroundColor(Color.parseColor("#515151"));
        Intent goslow = new Intent(SliderManager.this, MyTraffic.class);
        startActivity(goslow);
    ...
    private void ll_inboxClick() {
        ...
        Intent inbox=new Intent(SliderManager.this,Inbox.class);
        startActivity(inbox);
    ...
    private void ll_settingClick() {
        ...
        Intent setting = new Intent(SliderManager.this, Setting.class);
...
//friends location
    private void ll_advertiseClick() {
        ...
        Intent friends = new Intent(SliderManager.this, FriendLocation.class);
