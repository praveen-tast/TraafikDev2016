...
class User extends BaseUser
{
	...
	*/
	...
	public static function getUserBycontact_no($name)
	{
		$user = User::model()->findByAttributes(array ( 'mobile'=>$name));
		return $user;
	}
	public static function getUserByName($name)
	{
		$user = User::model()->active()->findByAttributes(array ( 'full_name'=>$name));
		return $user;
	}
	...
	public static function getOnlineUsers()
	{
		...
		$criteria->addInCondition('state_id', array(User::STATUS_ACTIVE));
	...
	{
		Message::model()->deleteAllByAttributes(array ('from_id'=>$this->id));
	...
	public function toArray()
	{
		...
		$image_url = isset($this->image_file) ? Yii::app()->createAbsoluteUrl('user/download',array('file'=>$this->image_file)) :
