...
class LocationGroupController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'LocationGroup');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'location-group-form');

		if (isset($_POST['LocationGroup'])) {
			$model->setAttributes($_POST['LocationGroup']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'LocationGroup')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('LocationGroup');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['LocationGroup']))
		{
			$model->setAttributes($_GET['LocationGroup']);
	...
	{
		$model = new LocationGroup('search');
		$model->unsetAttributes();
		$this->updateMenuItems($model);
	...
	{	
		...
		if ( $model == null ) $model = new LocationGroup();
