...
class ReportCauseController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'ReportCause');
	...
	{
		$model = new ReportCause;

		$this->performAjaxValidation($model, 'report-cause-form');

		if (isset($_POST['ReportCause'])) {
			$model->setAttributes($_POST['ReportCause']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'ReportCause')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('ReportCause');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['ReportCause']))
		{
			$model->setAttributes($_GET['ReportCause']);
	...
	{	
		...
		if ( $model == null ) $model = new ReportCause();
