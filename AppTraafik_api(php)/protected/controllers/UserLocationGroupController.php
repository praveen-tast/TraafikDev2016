...
class UserLocationGroupController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'UserLocationGroup');
	...
	{
		$model = new UserLocationGroup;

		$this->performAjaxValidation($model, 'user-location-group-form');

		if (isset($_POST['UserLocationGroup'])) {
			$model->setAttributes($_POST['UserLocationGroup']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'UserLocationGroup')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('UserLocationGroup');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['UserLocationGroup']))
		{
			$model->setAttributes($_GET['UserLocationGroup']);
	...
	{
		$model = new UserLocationGroup('search');
		$model->unsetAttributes();
		$this->updateMenuItems($model);
	...
	{	
		...
		if ( $model == null ) $model = new UserLocationGroup();
