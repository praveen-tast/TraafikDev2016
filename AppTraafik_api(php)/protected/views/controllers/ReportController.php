...
class ReportController extends GxController {
	...
	{	
		...
		if ( $model == null ) $model = new Report();
			...
			case 'view':
				{
					...
					$this->menu[] = array('label'=>Yii::t('app', 'Add ReportCauses'), 'url'=>array('reportCause/create'),'icon'=>'icon-plus icon-white','visible'=> Yii::app()->user->isAdmin);
				}
				break;
		}
