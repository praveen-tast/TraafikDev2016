...
class InvitationController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'Invitation');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'invitation-form');

		if (isset($_POST['Invitation'])) {
			$model->setAttributes($_POST['Invitation']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'Invitation')->delete();
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['Invitation']);
	...
	{	
		...
		if ( $model == null ) $model = new Invitation();
