...
?>
	...
	<div class="row">
		...
		<?php $this->richTextEditor($model,'message'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'model_type', array('maxlength' => 100)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'model_action'); ?>
		<?php echo $form->textField($model, 'model_action', array('maxlength' => 100)); ?>
	</div>
