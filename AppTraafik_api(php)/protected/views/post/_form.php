...
<?php 
/*
       * echo $form->textFieldRow($model,'report_cause_id',array('class'=>'span5')); ?>
       *
       * <?php echo $form->dropDownListRow($model, 'report_cause_id',GxHtml::listDataEx(ReportCause::model()->findAll()));
       */
?>
...
<?php echo $form->dropDownListRow ( $model, 'side_id', $model->getSideOptions () ); ?>
<?php
...
if ($code == 1)
	...
	echo $form->redactorRow ( $model, 'content', array (
			'class' => 'span4',
			'rows' => 5 
	) );
else if ($code == 3)
...
<?php
echo $form->dropDownListRow ( $model, 'state_id', $model->getStatusOptions () );
?>

<?php
echo $form->dropDownListRow ( $model, 'type_id', $model->getTypeOptions () );
?>
...
echo $form->datepickerRow ( $model, 'update_time', array (
